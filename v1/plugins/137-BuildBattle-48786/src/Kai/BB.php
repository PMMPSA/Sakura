...
class BB extends PluginBase implements Listener {
	...
	{
		$this->getLogger()->notice(TE::AQUA . "BuildBattle by DragonPlayzMC");
        ...
        public function onLog(PlayerLoginEvent $event)
	{
            ...
            if(in_array($level,$this->arenas))
            {
                ...
                if($time<=170)
                {
                    if($config->get("actual".$level)!=$player->getName())
                    {
                        ...
                        {
                            $player->sendTip(TE::BOLD.TE::DARK_RED."RẤT XẤU");
                        }
                        elseif($event->getItem()->getDamage()==6)
                        {
                            $player->sendTip(TE::BOLD.TE::RED."XẤU");
                        }
                        ...
                        {
                            $player->sendTip(TE::BOLD.TE::DARK_GREEN."TỐT");
                        }
                        elseif($event->getItem()->getDamage()==11)
                        {
                            $player->sendTip(TE::BOLD.TE::DARK_PURPLE."ĐẸP");
                        }
                        elseif($event->getItem()->getDamage()==4)
                        {
                            $player->sendTip(TE::BOLD.TE::GOLD."TUYỆT ĐẸP");
                        }
                    }
                    else
                    {
                        $player->sendTip(TE::BOLD.TE::RED."Bạn không thể vote cho plot của mình");
                    }
                }
            }
        }
        ...
        public function getConfirm($damage){
            ...
            if($damage == 13){
                return TE::DARK_GREEN."TỐT";
            }
            if($damage == 11){
                return TE::DARK_PURPLE."ĐẸP";
            }
            if($damage == 4){
                return TE::GOLD."TUYỆT ĐẸP";
            }
            return TE::DARK_RED."RẤT XẤU ";
        }
				...
				if($text[3] == $this->prefix)
				{
					if($text[0]==TE::AQUA . "§7[ §fJoin §7]")
					{
						$config = new Config($this->getDataFolder() . "/config.yml", Config::YAML);
                                                ...
                                                with:
                                                $slots->save();
                                                $player->sendMessage($this->prefix . "Bạn đã tham gia BuildBattle!");
                                                foreach($level->getPlayers() as $playersinarena)
                                                {
                                                $playersinarena->sendMessage($player->getNameTag() .TE::AQUA. " tham gia trận đấu");
                                                }
					...
					{
						$player->sendMessage($this->prefix . "Bạn không thể vào bây giờ!");
					}
				}
			}
		}
					...
					else
					{
						...
						if($config->get($arena . "start")==1)
						{
							if($timeToStart>0)
							{
								...
								{
									$pl->sendTip(TE::WHITE."Trận đấu sẽ bắt đầu sau ".TE::GREEN . $timeToStart . TE::RESET);
                                                                        if($timeToStart<=5)
                                                                        {
							...
							else
							{
                                                                ...
                                                                if($time>170)
                                                                {
                                                                    foreach($playersArena as $pla)
                                                                    {
                                                                        $pla->sendTip(TE::BOLD.TE::AQUA."Theme: " .TE::GREEN. $tema .TE::AQUA. "  Thời gian còn lại: ".TE::YELLOW.$minutes.TE::DARK_PURPLE.":".TE::YELLOW.$seconds. TE::RESET);
                                                                    }
                                                                }
								$time--;
								if($time == 469)
								{
									...
									foreach($playersArena as $pl)
									{
                                                                            ...
                                                                            $pl->sendMessage(TE::YELLOW."> ".TE::WHITE."Xây gì đó liên quan đến chủ đề");
								...
								if($time>170)
									...
									if(is_int($minutes) && $minutes>0)
									{
										foreach($playersArena as $pl)
										{
											$pl->sendMessage($this->prefix .TE::YELLOW. $minutes . " " .TE::GREEN."phút còn lại");
										}
									}
									elseif($time2 == 30 || $time2 == 15 || $time2 == 10 || $time2 ==5 || $time2 ==4 || $time2 ==3 || $time2 ==2 || $time2 ==1)
									{
										foreach($playersArena as $pl)
										{
											$pl->sendMessage($this->prefix .TE::YELLOW. $time2 . " " .TE::GREEN. "giây còn lại");
                                                                                        $levelArena->addSound(new PopSound($pl));
										}
									}
								}
                                                                else
                                                                {
                                                                    if($time == 166 || $time == 156 || $time == 146 || $time ==136 || $time ==126 || $time ==116 || $time ==106 || $time ==96 || $time ==86 || $time ==76 || $time ==66 || $time ==56 || $time ==46 || $time ==36 || $time ==26)
                                                                    {
                                                                            foreach($playersArena as $pl)
                                                                            {
                                                                                    $pl->sendMessage($this->prefix .TE::GREEN. "Còn lại " .TE::YELLOW. "5" .TE::GREEN. " giây");
                                                                                    $levelArena->addSound(new PopSound($pl));
                                                                            }
                                                                    }
                                                                    elseif($time == 165 || $time == 155 || $time == 145 || $time ==135 || $time ==125 || $time ==115 || $time ==105 || $time ==95 || $time ==85 || $time ==75 || $time ==65 || $time ==55 || $time ==45 || $time ==35 || $time ==25)
                                                                    {
                                                                            foreach($playersArena as $pl)
                                                                            {
                                                                                    $pl->sendMessage($this->prefix .TE::GREEN. "Còn " .TE::YELLOW. "4" .TE::GREEN. " giây");
                                                                                    $levelArena->addSound(new PopSound($pl));
                                                                            }
                                                                    }
                                                                    elseif($time == 164 || $time == 154 || $time == 144 || $time ==134 || $time ==124 || $time ==114 || $time ==104 || $time ==94 || $time ==84 || $time ==74 || $time ==64 || $time ==54 || $time ==44 || $time ==34 || $time ==24)
                                                                    {
                                                                            foreach($playersArena as $pl)
                                                                            {
                                                                                    $pl->sendMessage($this->prefix .TE::GREEN. "Còn lại" .TE::YELLOW. "3" .TE::GREEN. " giây");
                                                                                    $levelArena->addSound(new PopSound($pl));
                                                                            }
                                                                    }
                                                                    elseif($time == 163 || $time == 153 || $time == 143 || $time ==133 || $time ==123 || $time ==113 || $time ==103 || $time ==93 || $time ==83 || $time ==73 || $time ==63 || $time ==53 || $time ==43 || $time ==33 || $time ==23)
                                                                    {
                                                                            foreach($playersArena as $pl)
                                                                            {
                                                                                    $pl->sendMessage($this->prefix .TE::GREEN. "Còn lại " .TE::YELLOW. "2" .TE::GREEN. " giây");
                                                                                    $levelArena->addSound(new PopSound($pl));
                                                                            }
                                                                    }
                                                                    elseif($time == 162 || $time == 152 || $time == 142 || $time ==132 || $time ==122 || $time ==112 || $time ==102 || $time ==92 || $time ==82 || $time ==72 || $time ==62 || $time ==52 || $time ==42 || $time ==32 || $time ==22)
                                                                    {
                                                                            foreach($playersArena as $pl)
                                                                            {
                                                                                    $pl->sendMessage($this->prefix .TE::GREEN. "Còn lại " .TE::YELLOW. "1" .TE::GREEN. " giây");
                                                                                    $levelArena->addSound(new PopSound($pl));
                                                                            }
                                                                    }
                                                                    elseif($time == 161 || $time == 151 || $time == 141 || $time ==131 || $time ==121 || $time ==111 || $time ==101 || $time ==91 || $time ==81 || $time ==71 || $time ==61 || $time ==51 || $time ==41 || $time ==31 || $time ==21)
                                                                    {
                                                                            foreach($playersArena as $pl)
                                                                            {
                                                                                    $pl->sendMessage($this->prefix .TE::GREEN. "Còn lại " .TE::YELLOW. "0" .TE::GREEN. " giây");
                                                                                    $levelArena->addSound(new PopSound($pl));
                                                                            }
                                                                    }
                                                                    if($time==11 || $time==21 || $time==31 || $time==41 || $time==51 || $time==61 || $time==71 || $time==81 || $time==91 || $time==101 || $time==111 || $time==121 || $time==131 || $time==141 || $time==151 || $time==161)
                                                                    {
                                                                        ...
                                                                        foreach ($playersArena as $pl)
                                                                        {
                                                                            ...
                                                                            if($yo!=$pl->getName())
                                                                            {
                                                                                ...
                                                                                $points->save();
                                                                                $pl->sendMessage($this->prefix .TE::YELLOW. "Bạn đã vote: ".TE::BOLD.$voto);
                                                                            }
                                                                        }
                                                                    }
                                                                    if($time==170)
                                                                    {
                                                                        ...
                                                                        if($slots->get("slot1".$arena)!=null)
                                                                        {
                                                                            ...
                                                                            foreach($playersArena as $pl)
                                                                            {
                                                                                ...
                                                                                $pl->sendMessage($this->prefix .TE::YELLOW. "Chủ sỡ hữu: " .TE::WHITE. TE::AQUA. $actual);
                                                                            }
                                                                        }
                                                                        else
                                                                        {
                                                                    ...
                                                                    if($time==10)
                                                                    {
                                                                        ...
                                                                        $this->plugin->getServer()->broadcastMessage($this->prefix .TE::YELLOW. ">> ".TE::AQUA."Người thắng cuộc $arena ".TE::GREEN."($tema)");
                                                                        ...
                                                                        $this->plugin->getServer()->broadcastMessage($this->prefix .TE::YELLOW. "2nd°: ".TE::AQUA.$quien2." ".TE::GREEN.$val[1]);
                                                                        unset($paints[$quien2]);
                                                                        $quien3 = array_search($val[2], $paints);
                                                                        $this->plugin->getServer()->broadcastMessage($this->prefix .TE::YELLOW. "3rd°: ".TE::AQUA.$quien3." ".TE::GREEN.$val[2]);
                                                                        foreach($playersArena as $pl) {
                                                                            ...
                                                                            $pl->sendMessage($this->prefix .TE::GREEN. "Điểm của bạn: ".TE::YELLOW.$tupos."°: ".TE::GREEN.$puntaje);
                                                                            $pl->teleport($spawn,0,0);
                                                                        }
                                                                    }
                                                                    if($time<=0)
						...
						else
						{
                                                    foreach($playersArena as $pl)
                                                    {
                                                            $pl->sendTip(TE::YELLOW . "Cần thêm người chơi" .TE::RESET);
                                                    }
                                                    $config->set($arena . "PlayTime", 470);
                                                    $config->set($arena . "StartTime", 30);
						}
