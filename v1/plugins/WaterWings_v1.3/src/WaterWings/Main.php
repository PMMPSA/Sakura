...
class Main extends PluginBase implements Listener{
	...
	public function onEnable()
	{
		...
		if(!is_file($df . "config.yml")){
			...
			$cfg->setAll([
				"wings-off" => "§b⚔§aCánh Đã §dTắt§a Ghi §e/wingwater§a Để §dBật§b⚔",
				"wings-on" => "§b⚔§aCánh Đã §dBật§a Ghi §e/wingwater§a Để §dTắt§b⚔",
				"update-period" => 1
			]);
			$cfg->save();
		}
