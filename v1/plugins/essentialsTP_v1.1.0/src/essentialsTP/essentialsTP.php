...
class essentialsTP extends PluginBase  implements CommandExecutor, Listener {
    ...
    public function create_db(){
        ...
        if ($count == 0){
            $this->prepare = $this->db2->prepare("CREATE TABLE homes (
                      ...
                      world TEXT)");
            $this->result = $this->prepare->execute();
            $this->getLogger()->info(TextFormat::AQUA."§4༺§eEssentialsTP§4༻§a   Cơ Sở Dữ Liệu Homes Đã Được Tạo!");
        }
        ...
        if ($count2 == 0){
            $this->prepare = $this->db2->prepare("CREATE TABLE tp_requests (
                      ...
                      status TEXT)");
            $this->result = $this->prepare->execute();
            $this->getLogger()->info(TextFormat::AQUA."§4༺§eEssentialsTP§4༻§a  Yêu Cầu Cơ Sở Dữ Liệu Được Tạo!");
        }
        ...
        if($count3 == 0){
            $this->prepare = $this->db2->prepare("CREATE TABLE warps (
                      ...
                      title TEXT)");
            $this->result = $this->prepare->execute();
            $this->getLogger()->info(TextFormat::AQUA."§4༺§eEssentialsTP§4༻§a   Cơ Sở Dữ Liệu Warps Đã Được Tạo!");
        }
        ...
        if($count4 == 0){
            ...
            $this->result = $this->prepare->execute();
            $this->getLogger()->info(TextFormat::AQUA."§4༺§eEssentialsTP§4༻§a Đã Tạo Cơ Sở Dữ Liệu!");
        }
        ...
        if($count5 == 0){
            ...
            $this->result = $this->prepare->execute();
            $this->getLogger()->info(TextFormat::AQUA."§4༺§eEssentialsTP§4༻§a  Cơ Sở Dữ Liệu CoolDown Đã Được Tạo!");
        }
    ...
    public function check_config(){
        ...
        {
            $this->config->set("MOTD", "§4༺§eEssentialsTP§4༻§a Chào Mừng Bạn Vui Lòng Thay Đổi Motd Trong Config");
            $this->config->save();
        }
    ...
    public function onEnable(){
        $this->getLogger()->info(TextFormat::GREEN."§4༺§eEssentialsTP§4༻§a EssentialsTP Đang Khởi Động...");
        ...
        $this->create_db();
        $this->getLogger()->info(TextFormat::GREEN."§4༺§eEssentialsTP§4༻§a EssentialsTP Đang Khởi Động: §f[§b".TextFormat::GOLD."config.yml".TextFormat::GREEN."§f]§a....");
        $this->tpa_cooldown = time() - $this->config->get("tpa-here-cooldown");
        $this->getLogger()->info(TextFormat::GREEN."§4༺§eEssentialsTP§4༻§a EssentialsTP Đã Khởi Động:§f [§b".TextFormat::GOLD."config.yml".TextFormat::GREEN."§f]§a Thành Công");
        $this->getLogger()->info(TextFormat::GREEN."§4༺§eEssentialsTP§4༻§a EssentialsTP Đã Hoạt Động");
    ...
    public function onDisable(){
        $this->prepare->close();
        $this->getLogger()->info("§4༺§eEssentialsTP§4༻§c EssentialsTP Đã Ngừng Hoạt Động");
    }
